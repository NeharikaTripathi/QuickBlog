  ...
  return data ? (
    <div className='relative'>
       ...
       className='text-center mt-20 text-gray-600'>
        ...
        text-sm border-primary/35 bg-primary/5 font-medium
         text-primary'>
            Michael Brown</p>
       </div>
        {/* the blog image and content */}
                ...
                <div className='flex flex-col gap-4'>
                    {comments.map((item, index)=>(
                        ...
                        className='relative bg-primary/2 border
                         border-primary/5 max-w-xl p-4 rounded
                          text-gray-600'>
                            ...
                            <div className='absolute right-4 botom-3 flex items-center
